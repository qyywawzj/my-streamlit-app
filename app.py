...
if generate:
    ...
    if recognized:
        ...
        for name, recipe in RECIPES.items():
            ...
            # 特殊排除规则
            # 1. 番茄+鸡蛋组合时排除番茄意大利面
            if set(recognized) == {'番茄', '鸡蛋'} and name == "番茄意大利面":
                continue
            # 2. 土豆+猪肉组合时排除菠菜土豆泥
