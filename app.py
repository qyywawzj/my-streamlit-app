...
def get_core_recipes():
    CORE_RECIPES = {
        "土豆丝炒肉": {
            "category": "炒菜",
            "time": "25分钟",
            "img_url": "https://images.unsplash.com/photo-1563245372-f21724e3856d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cG90YXRvJTIwc3RpcnxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=800&q=60",
            "ingredients": [
                {"name": "土豆", "amount": "400g"},
        ...
        "土豆烧肉": {
            "category": "炒菜",
            "time": "40分钟",
            "img_url": "https://images.unsplash.com/photo-1603065754031-a5c34d7764e6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cG90YXRvJTIwc3Rld3xlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=800&q=60",
            "ingredients": [
                {"name": "土豆", "amount": "300g"},
        ...
        "番茄炒蛋": {
            "category": "炒菜",
            "time": "15分钟",
            "img_url": "https://images.unsplash.com/photo-1574539602047-548bf9557352?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8dG9tYXRvJTIwZWdnfGVufDB8fDB8fHww&auto=format&fit=crop&w=800&q=60",
            "ingredients": [
                {"name": "番茄", "amount": "300g"},
                {"name": "鸡蛋", "amount": "3个"},
                {"name": "白糖", "amount": "5g"},
        ...
        "番茄鸡蛋汤": {
            "category": "汤类",
            "time": "15分钟",
            "img_url": "https://images.unsplash.com/photo-1592417817098-8fd3d9eb14a5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8dG9tYXRvJTIwc291cHxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=800&q=60",
            "ingredients": [
                {"name": "番茄", "amount": "200g"},
                {"name": "鸡蛋", "amount": "2个"},
                {"name": "葱花", "amount": "10g"},
        ...
        "番茄鸡蛋豆腐羹": {
            "category": "汤羹",
            "time": "20分钟",
            "img_url": "https://images.unsplash.com/photo-1546833999-b9f581a1996d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8dG9mdXxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=800&q=60",
            "ingredients": [
                {"name": "番茄", "amount": "1个"},
                {"name": "鸡蛋", "amount": "1个"},
...
def render_recipes():
    ...
    with st.sidebar:
        ...
        selected_series = st.selectbox("选择菜品系列", series_options, key="series_select")
        
        st.subheader("烹饪类型")
        cook_types = set([data["category"] for data in recipes.values()])
        type_options = ["全部"] + sorted(list(cook_types))
        selected_type = st.selectbox("选择烹饪类型", type_options, key="type_select")
        
        st.subheader("烹饪时间")
        time_filter = st.slider("最大烹饪时间（分钟）", 15, 60, 60, key="time_slider")
        
        st.subheader("食材搜索")
        search_ingredient = st.text_input("输入食材名称", key="search_input")
        
        if st.button("🔄 重置筛选条件", key="reset_btn"):
            st.rerun()
